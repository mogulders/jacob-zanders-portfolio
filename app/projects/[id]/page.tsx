...
export default function ProjectDetailPage() {
    ...
    useEffect(() => {
        async function loadProject() {
            ...
            // Check if it's a hardcoded project
            if (hardcodedProjects[params.id]) {
                setProject(hardcodedProjects[params.id]);
                setIsLoading(false);
                return;
            }

            // If project not found in hardcoded projects, redirect
            ...
            <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <div className="animate-pulse">
                        ...
                        <div className="h-6 bg-slate-200 dark:bg-slate-800 rounded w-full mb-8" />
